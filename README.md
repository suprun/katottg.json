# (Оновлено) Кодифікатор адміністративно-територіальних одиниць та територій територіальних громад України (КАТОТТГ) у форматі JSON

Актуальні дані КАТОТТГ України (Станом на 02.07.2025). Дані постійно оновлюються. Попередні версії знаходяться в директорії [katottg_schema.json](archive)``, поточні — в кореневому каталозі.
