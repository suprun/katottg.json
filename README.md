...
## Представлена базова версія версія структори кодифікатора у форматі JSON та кілька її модифікацій:

### 1. `katottg.json` (Базова версія) ~ 7.57 Mb
...
### 2. `katottg_minimal.json` (Компактна версія) ~ 4.33 Mb
