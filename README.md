...
Актуальні дані КАТОТТГ України (Станом на 02.07.2025). Попередні версії знаходяться в директорії [archive](archive), поточні — в кореневому каталозі. У зв’язку з перейменуванням, утвореннчм, зміною меж окремих адміністративно-територіальних одиниць дані в класифікаторі пнріодично оновлюються.
